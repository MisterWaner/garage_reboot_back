...
export class UniqueUserIdGenerator implements UniqueUserIdService {
    ...
    private baseId(firstname: string, lastname: string, birthdate: Date): string {
        const firstPart = 'VP';
    ...
    async generateUniqueId(firstname: string, lastname: string, birthdate: Date): Promise<string> {
